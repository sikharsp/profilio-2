  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <p className="text-primary mb-2 animate-fade-in" style={{animationDelay: '0.0s'}}>Hello, I'm</p>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 animate-fade-in" style={{animationDelay: '0.0s'}}>
          Sikhar Panthi
        </h1>
        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto animate-fade-in" style={{animationDelay: '0.0s'}}>
